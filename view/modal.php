                   ...
                   <input type="hidden" name="id_client" value="'.$id_client.'" />
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" value="'.$ip_client.'" placeholder="Masukkan IP" name="ip" class="form-control" data-inputmask="\'alias\': \'ip\'" data-mask="" required>
                        </div><!-- /.input group -->
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="client"  value="'.$name_client.'" class="form-control" placeholder="Masukkan Nama Host" required>
                        </div><!-- /.input group --> 
                        </div>
                      </div>
                      <div class="form-group">
